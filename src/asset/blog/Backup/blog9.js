...
export function Blog9(){
    ...
    <div>
        ...
        <Index_Top type="blog"/>
            ...
            <h1>Priest Beneath</h1>
    <h2>2023 CAMBRIDGE GAME JAM  <br/></h2>
    <p><a href="https://itch.io/jam/camgamejam">Cambridge GAME JAM</a><br/>
    <a href="https://itch.io/jam/camgamejam/rate/1923196">Our submission</a> <br/>
    </p>
    <h2 id="unitygamec">Unity GAME (C#)</h2>
    Press SPACE key to survive~  <br/>
    <a href="https://peterhuistyping.github.io/Priest-Beneath/">Click HERE to Play!</a>
     <br/>
    <img class="img_normal" src="asset/photo/Assignment/9/Web.png" alt="Web" />  <br/>
    <h2>Thank for our great teammates collaborative working on this amazing Unity Game.</h2>
    <h2 id="intro">Intro</h2>
    <p>Be a priest, but beneath! With your super minigun made in 2077, break barriers to increase your shooting speed, and survive! Don't forget to hunt down the sprites to get COOOOOoOL buffs!
    <img class="img_normal"  src="asset/photo/Assignment/9/Frozen.png" alt="Frozen" title="Frozen" /></p>
    <h2>Story Line</h2>
