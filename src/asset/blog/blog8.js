...
export function Blog8(){
    ...
    <pre><code>Your accuracy: 0.6355555555555555
    ...
    <pre><code>Your accuracy using simple classifier: 0.63
    ...
    <pre><code>The p-value of the two-sided sign test for classifier_a "classifier simple" and classifier_b "classifier magnitude": 0.6722499772048186
