...
export function AboutMe(){
    ...
    <div class="aboutMeContainer">
        ...
        &emsp; &nbsp;&nbsp;
        covering ray tracing, materials, synthesis, BRDF, hair modeling, geometry representations, etc. The tasks taken include synthesis, reconstruction, classification, etc. In the past few years, I have developed or maintained several renderers in multiple languages (C++, Python, GLSL). I also present multiple knowledge sharing sessions about my research topics both internally during internship and in university. <br/> 
        <center>
        {/* 1568 1340 = 1.17 */}
