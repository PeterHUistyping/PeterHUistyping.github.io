...
function LegacyAcademicDescription(){
    ...
    return(
        ...
        <br/>     
        Supported by <a href="#/award">several grants and scholarships</a> from both my college and department, my undergraduate research is supervised by Dr <a href="https://chenliang-zhou.github.io/">Chenliang Zhou</a> on generative machine learning and Dr <a href="https://asztr.github.io/">Alejandro Sztrajman</a> on real-world captured <a href="https://en.wikipedia.org/wiki/Bidirectional_reflectance_distribution_function">BRDF (Bidirectional Reflectance Distribution Function)</a>. Besides, I am mentored by
